# Advanced Attention U-Net model

import torch.nn.functional as F
from Modules.unet_parts_att_ad import *
...
class UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x4 = torch.cat([x4, x1to4], dim=1)  # 512+512 = 1024
        x4 = torch.cat([x4, x2to4], dim=1)  # 1024+512 = 1536
        x4 = torch.cat([x4, x3to4], dim=1)  # 1536+512 = 2048
        x4 = self.conv_sc4(x4)  # 2048 => 512
        x3 = torch.cat([x3, x1to3], dim=1)  # 256+256 = 512
        x3 = torch.cat([x3, x2to3], dim=1)  # 512+256 = 768
